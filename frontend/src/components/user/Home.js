...
import HomeImg from "../../assets/img/Accept request-bro.svg";
  ...
  return (
    <div>
      <div className="flex">
        ...
        <div>
          <img className="h-[600px] p-10 pl-20" alt="HomeImg" src={HomeImg} />
        </div>
      </div>
      <Testimonials />
      <Footer />
