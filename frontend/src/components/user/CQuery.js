  ...
  return (
    <div>
      <div className="flex flex-row ml-[80px]">
        <div className="px-2 py-4 mt-3 font-poppins">
          <div className="flex flex-col text-[50px] ml-center p-2">
            <p>
              Group Community <span className="">Query!</span>
            </p>
          </div>
              ...
              <form>
                ...
                <div className="">
                  ...
                  <div className="flex flex-row-reverse">
                    <button className="relative inline-flex items-center justify-center my-2 bg-black text-white px-3 py-2 rounded-md text-sm ">
              ...
              <div>
                <ul className="max-w-md space-y-2 text-gray-500 list-inside dark:text-gray-400">
                  <li className="flex items-center">
                    ...
                    <svg
                      className="w-4 h-4 mr-2 ml-2 text-green-500 dark:text-green-400 flex-shrink-0"
                      aria-hidden="true"
                      xmlns="http://www.w3.org/2000/svg"
                      fill="currentColor"
                      viewBox="0 0 20 20"
        ...
        <div className="py-8 mt-6 ml-8 text-[23px] font-poppins ">
          <div>
            Community{" "}
            <a href="/community">
              <button className="w-[97px] bg-slate-200 rounded-3xl items-center border border-gray-300 shadow-md">
                <span className="animate-pulse bg-gradient-to-l from-blue-600 via-green-600 to-indigo-400 inline-block text-transparent bg-clip-text">
                  <u> Chats</u>
                </span>
              </button>
            </a>
