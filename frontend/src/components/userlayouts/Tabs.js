...
import Profile from "../../assets/img/Avatar Image.svg";
  ...
  return (
    <Box sx={{ width: "100%", typography: "body1", fontFamily: "poppins" }}>
      <TabContext value={value}>
        ...
        <TabPanel value="4">
          <div classname="">
            <p className="flex justify-center font-semibold  text-[1.5em]">
              Let's Connect For Questions & Answer Session
            </p>
            <br />
            <br />

            <div className="flex justify-between">
              <label for="audio_fee" className="mx-2">
                Audio
                <input
                  type="text"
                  id="audio_fee"
            ...
            <div className="flex flex-col gap-4 ">
              ...
              <select className="">
                ...
                <option>
                  Acharya vidhaybhavan Matriculation Higher Secondary School
                </option>
                <option>
                  Acharya vidhaybhavan Matriculation Higher Secondary School
                </option>
            ...
            <div className="flex flex-col gap-4 ">
              <label className="font-bold">Colleges</label>
              <select className="">
                <option>Select one</option>
            ...
            {isToggled && (
              <div className="flex justify-center">
                <p>
                  Your code is{" "}
                  <span className="border p-2 bg-slate-200 rounded-xl">
                    540454
                  </span>
                </p>
                <br />
            ...
            <div className="flex justify-center">
              <button className="text-white rounded-md bg-black py-2 px-3">
                Proceed
              </button>
            </div>
          </div>
